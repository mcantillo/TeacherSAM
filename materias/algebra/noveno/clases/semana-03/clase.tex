...
% ---------------------------------------------------------------------
% BORRADOR: las filas 005 y 006 de curriculo/programacion.csv están VACÍAS. El tema, el
% subtema, el DBA y las marcas de taller y tarea se toman de la propuesta del trimestre I
% de curriculo/plan-anual.md, que la docente aún no ha aprobado, y NO se han escrito en
% programacion.csv.
% =====================================================================
...
\begin{nota}
\textbf{Pendiente.} Las filas 005 y 006 de \texttt{programacion.csv} están vacías: el
tema, el DBA y las marcas de taller y tarea salen de la propuesta del plan anual, que
falta aprobar. Además, los ejercicios de esta semana vienen del banco de Álgebra 8°
(\texttt{irracionales-8}): hay que decidir cómo se reparten los irracionales entre 8° y 9°
...
\begin{tabularx}{\linewidth}{@{}l l X@{}}
  ...
  Error & 6--22 & Definición de la guía: si $a$ aproxima a $x$, error absoluto
    ...
    $\num{0,0042}$ y relativo cercano al $\num{0,3}\,\%$. Escribir bien grande la regla de
