...
% ---------------------------------------------------------------------
% El plan anual quedó aprobado el 2026-09-18 y la fila 003 de
% curriculo/programacion.csv está llena desde el 2026-09-17: el tema, el subtema y el DBA
...
\begin{nota}
\textbf{Pendiente de esta sesión.} El plan marca \emph{tarea} para hoy y no se escribió:
el banco no tiene ejercicios verificados de giros para 7° (solo \texttt{angulos-7-003}, que
ya usa la guía). La práctica de la sesión va en el cuaderno y se revisa en clase.
\end{nota}
